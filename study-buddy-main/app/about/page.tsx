    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-6">About StudiPedia AI</h1>
          
          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-gray-700 mb-6 leading-relaxed">
              StudiPedia AI is an open-source AI personal tutor that runs locally on your computer, 
            ...
            <div className="space-y-6 mb-8">
              <div>
                ...
                <Image
                  src={desktopImg}
                  alt="StudiPedia AI Desktop Interface"
              ...
              <div>
                ...
                <Image
                  src={mobileImg}
                  alt="StudiPedia AI Mobile Interface"
            ...
            <p className="text-gray-700 mb-4">
              StudiPedia AI is fully open source and released under the MIT License. 
              We believe in making education accessible to everyone through open collaboration.
            </p>
            
            <div className="flex flex-wrap gap-4">
              <a
                href="https://github.com/Payal13052003/StudiPedia-AI"
                target="_blank"
                rel="noopener noreferrer"
